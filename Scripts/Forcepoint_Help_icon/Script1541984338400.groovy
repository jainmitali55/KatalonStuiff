...
WebUI.click(findTestObject('Object Repository/Page_Forcepoint Policy Distribution/Main_Help_option'));
WebUI.switchToWindowIndex(1);
WebUI.switchToWindowIndex(0);
WebUI.click(findTestObject('Object Repository/Page_Forcepoint Policy Distribution/Help_Icon'));
WebUI.verifyTextPresent(WebUI.getText(findTestObject('Object Repository/Page_Forcepoint Policy Distribution/Page_Help_option')),false);
WebUI.click(findTestObject('Object Repository/Page_Forcepoint Policy Distribution/Page_Help_option'));
